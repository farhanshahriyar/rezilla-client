...
const navigation = [
  ...
  { name: 'All Properties', href: '/all-properties', current: false, requiresAuth: true },
]
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  {/* <img
                    ...
                    alt="Your Company"
                  /> */}
                    <a className="text-white font-bold text-2xl" href='/'>Rezilla</a>
                </div>
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex space-x-4">
                    ...
                    {navigation
                      .filter(item => !item.requiresAuth || (item.requiresAuth && user)) // this line filters out auth-required items if user is not logged in
                      .map((item) => (
                        <a
                          key={item.name}
                          href={item.href}
