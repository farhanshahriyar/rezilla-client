...
export default function AllProperties() {
  ...
  const [properties, loading, max, setMax, min, setMin, range, setRange, setProperties, properties2] = useProperties(); // used custom hook here
  // console.log(max)
  ...
  const onChange = ( value1 ) => {
    setRange([value1, max])
    const filtered = properties2.filter((property) => property.price >= value1 && property.price <= max);
                      ...
                      <>
                        ...
                        <Disclosure.Panel className="pt-6">
                          <div className="space-y-4">
                            ...
                            <PriceRange onChange={onChange} min = {min} max = {max} range = {range}
                            />
                            max: {range[1]} 
                            min: {range[0]}
                          </div>
