...
const SignUp = () => {
    ...
    <div>
        <Helmet>
                <title>Rezilla - SignUp in Rezilla</title>
        </Helmet>
              ...
              <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                ...
                <div className="grid items-center md:grid-cols-2 gap-8 lg:gap-12">
                  <div>
                    ...
                    Rezilla a Real Estate Agency 
                    </p>


                    <div className="mt-4 md:mb-12 max-w-2xl">
                      <h1 className="mb-4 font-semibold text-gray-800 text-4xl lg:text-5xl dark:text-gray-200">
                        Fully trusted by the people
                      </h1>
                      <p className="text-gray-600 dark:text-gray-400">
                        We provide you with a best properties in the world. We are here to help you to find the best properties for you.
                      </p>
                    </div>
                    ...
                    <blockquote className="hidden md:block relative max-w-sm">
                      ...
                      <div className="relative z-10">
                        <p className="text-xl italic text-gray-800 dark:text-white">
                          Amazing people are working in Rezilla and they are providing best and budget friendly properties in the modern world.
                        </p>
                      </div>
                      ...
                      <div className="lg:max-w-lg lg:mx-auto lg:me-0 ms-auto">
                        ...
                        <div className="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg dark:bg-slate-900">
                          <div className="text-center">
                            <h1 className="block text-2xl font-bold text-gray-800 dark:text-white">Start your account</h1>
                          ...
                          <div className="mt-5">
                            <button onClick={handleGoogleSignIn} type="button" className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              ...
                              <div>
                                ...
                                <div className="relative">
                                  <input type="text" {...register("username", { required: true })} name='username' className="peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600
                                  focus:pt-6
                                  focus:pb-2
                              ...
                              <div>
                                ...
                                <div className="relative">
                                  <input type="number" {...register("number", { required: true })}  name='number'  className="peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600
                                  focus:pt-6
                                  focus:pb-2
                                  [&:not(:placeholder-shown)]:pt-6
                                  [&:not(:placeholder-shown)]:pb-2
                                  ...
                                  <label  className="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                                    ...
                                    peer-[:not(:placeholder-shown)]:text-xs
                                    peer-[:not(:placeholder-shown)]:-translate-y-1.5
                                    peer-[:not(:placeholder-shown)]:text-gray-500">Phone number</label>
                                </div>
                              ...
                              <div>
                                ...
                                <div className="relative">
                                  <input type="email" {...register("email", { required: true })}  name='email' className="peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600
                                  focus:pt-6
                                  focus:pb-2
                                  [&:not(:placeholder-shown)]:pt-6
                                  [&:not(:placeholder-shown)]:pb-2
                                  autofill:pt-6
                                  autofill:pb-2" placeholder="you@example.com"/>
                                  {/* errors will return when field validation fails  */}
                              ...
                              <div>
                                <div className="relative">
                                  <select name='category' {...register("category")}  className="block w-full py-3 px-4 bg-white border border-gray-200 rounded-lg text-sm text-gray-700 focus:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400">
                        ...
                        <div className="relative col-span-full">
                            <div className="relative">
                                ...
                                })} name='password' className="peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600
                                focus:pt-6
                                focus:pb-2
                                [&:not(:placeholder-shown)]:pt-6
                                [&:not(:placeholder-shown)]:pb-2
                                ...
                                {errors.password?.type === 'minLength' && <span className='text-red-500 text-sm'> *You dont have minimum 6 length of password</span>}
                                {errors.password?.type === 'maxLength' && <span className='text-red-500 text-sm'> *You have to less than 20 length of password</span>}
                                {errors.password?.type === 'pattern' && <span className='text-red-500 text-sm'> *Password must have one uppercase letter, lowercase letter, special case letter, special digits</span>}
                                <label className="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                                peer-focus:text-xs
                                peer-focus:-translate-y-1.5
                                peer-focus:text-gray-500
                                ...
                                <button onClick={togglePasswordVisibility} type="button" className="absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5">
                        ...
                        <div className="col-span-full">
                            <div className="relative">
                                ...
                                })} name='confirmpassword' className="peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600
                                focus:pt-6
                                focus:pb-2
                                [&:not(:placeholder-shown)]:pt-6
                                [&:not(:placeholder-shown)]:pb-2
                                ...
                                <button onClick={toggleConfirmPasswordVisibility} type="button" className="absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5">
                ...
                <div className="mt-6 md:mt-12 py-3 flex items-center text-sm text-gray-800 gap-x-1.5 after:flex-[1_1_0%] after:border-t after:border-gray-200 after:ms-6 dark:text-white dark:after:border-gray-700">
                  ...
                  individuals and group of people trust Rezilla to find their dream home.
                </div>
