  ...
  return (
    <div>
        ...
        <div className="w-64 min-h-screen min-w-fit bg-green-900">
            ...
            <li className="mb-2"><Link to="/dashboard/add-property" className="px-4 py-2 flex text-white bg-green-700 rounded"><FaHome className='text-xl' />Manage User</Link></li>
            <li className="mb-2"><Link to="/dashboard/all-users" className="px-4 py-2 flex text-white bg-green-700 rounded"><FaUsers className='text-xl' />Manage Reviews</Link></li>
            </>
          )}
          {isAgent && (
            <>
              {/* Agent specific routes */}
              <li className="mb-2"><Link to="/dashboard/agent-profile" className="px-4 py-2 text-white bg-green-700 rounded flex"><FaUsers className='text-xl' />Agent Profile</Link></li>
